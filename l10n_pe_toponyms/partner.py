...
#    Copyright (C) 2011 Consultoria YarosLab SAC(<http://www.yaroslab.com>).
#
...
class res_partner(osv.osv):
    ...
    def _get_default_country(self, cr, uid, context=None):
        ...
        country_ids = country_obj.search(cr, uid, [('code', '=', 'PE'), ], limit=1)
        id = country_ids and country_ids[0] or False
        return id
